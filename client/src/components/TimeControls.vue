...
<template>
  <div class="time-controls">
    ...
    <!-- Step + Now row -->
    <div class="tc-row">
      <button class="tc-btn" type="button" aria-label="−1 day"   title="−1 day"   @click="telemetry.stepTime(-86400)">−1d</button>
      <button class="tc-btn" type="button" aria-label="−6 hours" title="−6 hours" @click="telemetry.stepTime(-21600)">−6h</button>
      <button class="tc-btn" type="button" aria-label="−1 hour"  title="−1 hour"  @click="telemetry.stepTime(-3600)">−1h</button>
      <button class="tc-btn" type="button" aria-label="−10 min"  title="−10 min"  @click="telemetry.stepTime(-600)">−10m</button>
      <button
        class="tc-btn tc-now"
        type="button"
